...
//		char *testt = "";
...
extern "C" int scanhash_verus(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done)
{
	...
	__m128i _ALIGN(32) register data_key[VERUS_KEY_SIZE128] = { 0 }; // 552 required
	__m128i _ALIGN(32) data_key_master[VERUS_KEY_SIZE128] = { 0 };
	...
	do {
		...
		*hashes_done = nonce_buf + throughput;
		...
		if (vhash[7] <= Htarg)
		{
			if (work_restart[0].restart>0 || work_restart[thr_id].restart>0)
				goto out;
